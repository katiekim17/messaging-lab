...
> 테스트 전체 코드: [TransactionalEventTrapTest.java#L176](https://github.com/katiekim17/messaging-lab/blob/53d2dee/src/test/java/com/example/messaging/step2_transactional_event/TransactionalEventTrapTest.java#L176)
> 예외 캡처 구현: [AfterCommitDbSaveListener.java#L68](https://github.com/katiekim17/messaging-lab/blob/53d2dee/src/main/java/com/example/messaging/step2_transactional_event/listener/AfterCommitDbSaveListener.java#L68)
...
assertThat(pointRepository.findByUserId(userId)).isPresent(); // 포인트: 이미 적립됨 → 불일치!
```

> 전체 코드: [EventListenerTimingTest.java#L81](https://github.com/katiekim17/messaging-lab/blob/e233ba1/src/test/java/com/example/messaging/step2_transactional_event/EventListenerTimingTest.java#L81)
...
> 전체 코드: [TransactionalEventTrapTest.java#L176](https://github.com/katiekim17/messaging-lab/blob/53d2dee/src/test/java/com/example/messaging/step2_transactional_event/TransactionalEventTrapTest.java#L176)
...
> 전체 코드: [TransactionalEventTrapTest.java#L115](https://github.com/katiekim17/messaging-lab/blob/53d2dee/src/test/java/com/example/messaging/step2_transactional_event/TransactionalEventTrapTest.java#L115)
...
> 실제 구현: [PointSaveService.java#L28](https://github.com/katiekim17/messaging-lab/blob/53d2dee/src/main/java/com/example/messaging/step2_transactional_event/listener/PointSaveService.java#L28)
...
> 전체 코드: [TransactionalEventTrapTest.java#L142](https://github.com/katiekim17/messaging-lab/blob/53d2dee/src/test/java/com/example/messaging/step2_transactional_event/TransactionalEventTrapTest.java#L142)
